    ...
    def _register_defaults(self) -> None:
        ...
        content_writer = Template(
            (
                ...
                "{{ strategy | tojson }}\n\n"
                "{% if pillar %}CURRENT PILLAR: {{ pillar }}{% endif %}\n"
                "{% if series %}\n"
                "CURRENT SERIES:\n"
                "{{ series | tojson }}\n"
                "{% endif %}\n"
                ...
                "{% endif %}\n"
                "{% if insights %}\n"
                "RESEARCH INSIGHTS YOU SHOULD USE (weave 1–2 into the post naturally):\n"
                ...
                "1) Start with a STRONG HOOK (1–2 sentences) that:\n"
                "   - describes a concrete situation, or\n"
                "   - uses a surprising fact/number, or\n"
                "   - calls out a pain of the audience directly.\n"
                "   DO NOT start with meta‑phrases like \"В этом посте я расскажу\", \"Сегодня поговорим\", \"В этом посте мы рассмотрим\".\n"
                "2) Middle part (2–5 short paragraphs):\n"
                "   - 1–3 specific ideas, frameworks or micro‑stories,\n"
                "   - use at least one concrete example (with numbers or vivid details),\n"
                "   - if relevant, weave in 1–2 research insights from the list above.\n"
                "3) Ending:\n"
                "   - 1–2 sentences that either summarise or open a loop to the next post,\n"
                "   - a natural CTA aligned with persona (ask for reflection, experience, questions),\n"
                "   - DO NOT use a generic \"Подписывайся\" without context.\n\n"
                "STYLE CONSTRAINTS:\n"
                ...
                "- Avoid repeating the same opening patterns across posts.\n\n"
