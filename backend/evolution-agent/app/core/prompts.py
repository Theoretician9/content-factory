    ...
    def _register_defaults(self) -> None:
        ...
        content_writer = Template(
            (
                ...
                "{% endif %}\n"
                "{% if source_snippets and source_snippets|length > 0 %}\n"
                "PRIMARY SOURCE TELEGRAM POST (use as factual base; DO NOT copy it verbatim):\n"
                "{% set s = source_snippets[0] %}\n"
                "[eng={{ s.engagement_total }} views={{ s.views_count }}] {{ s.text }}\n"
                "{% endif %}\n"
                "{% if insights %}\n"
                ...
                "STYLE CONSTRAINTS:\n"
                "- Target length: 1200–2500 characters of body text (not counting hashtags/CTA).\n"
                "- Hard limit: max 3000 characters of body text.\n"
