...
- [x] **[КРИТИЧНО]** Исправить привязку аккаунтов к пользователю - реализована JWT авторизация и изоляция по user_id. Каждый пользователь видит только свои интеграции
